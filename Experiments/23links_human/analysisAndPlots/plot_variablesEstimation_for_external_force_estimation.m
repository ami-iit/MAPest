...
% % % save
% % if saveON
% %     save2pdf(fullfile(bucket.pathToPlots, ('feet_fext_comparison')),fig,600);
% % end


%% Hands External Force Estimation
% % fig = figure('Name', 'Hands External forces','NumberTitle','off');
% % axes1 = axes('Parent',fig,'FontSize',16);
% % box(axes1,'on');
% % hold(axes1,'on');
% % grid on;
...
fext.measured.rightHand = y_sim((range_fextMEAS_rightHand:range_fextMEAS_rightHand+5),:);
...
fext.estimated.rightHand = estimation.mu_dgiveny((range_fextEST_rightHand:range_fextEST_rightHand+5 ),:);
...
fext.measured.leftHand = y_sim((range_fextMEAS_leftHand:range_fextMEAS_leftHand+5),:);
...
fext.estimated.leftHand = estimation.mu_dgiveny((range_fextEST_leftHand:range_fextEST_leftHand+5 ),:);
...
% % % save
% % if saveON
% %     save2pdf(fullfile(bucket.pathToPlots, ('hands_fext_comparison')),fig,600);
% % end
