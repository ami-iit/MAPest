...
%           hold(axes1,'on');
%
%           plot_power1 = plot(covTun.absErr_power1,'color',covTun.power1_col,'lineWidth',4);
%           hold on;
%           plot_power2 = plot(covTun.absErr_power2,'color',covTun.power2_col,'lineWidth',4);
%           hold on;
%           plot_power3 = plot(covTun.absErr_power3,'color',covTun.power3_col,'lineWidth',4);
%           hold on;
%           plot_power4 = plot(covTun.absErr_power4,'color',covTun.power4_col,'lineWidth',4);
%           grid on;
